...
class CommonConfig(FairseqDataclass):
    ...
    beam_search_hyps: bool = field(
        default=False, metadata={"help": "generate beam-search hyps for segment-level training"}
    )
    segment_level_training_start_iter: int = field(
        default=0, metadata={"help": "segment-level training start after this number of iteration"}
    )

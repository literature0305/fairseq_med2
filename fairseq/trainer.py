...
class Trainer(object):
    ...
    def train_step(self, samples, raise_oom=False, model_for_hyp=None):
        ...
        for i, sample in enumerate(samples):  # delayed update loop
            ...
            try:
                with maybe_no_sync():
                    ...
                    if model_for_hyp is not None:
                        generator = self.task.build_generator(
                            [model_for_hyp], self.cfg.generation
                        )
                    else:
                        generator = None
                    ...
                    loss, sample_size_i, logging_output = self.task.train_step(
                        ...
                        generator_for_hyp=generator,
                        model_for_hyp=model_for_hyp,
                        **extra_kwargs,
                    )
                    del loss

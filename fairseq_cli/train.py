...
def train(
    ...
    for i, samples in enumerate(progress):
        with metrics.aggregate("train_inner"), torch.autograd.profiler.record_function(
            ...
            num_updates_tmp = trainer.get_num_updates()
            if cfg.common.beam_search_hyps and num_updates_tmp >= cfg.common.segment_level_training_start_iter:
                # inference for segment-level-training
                log_output = trainer.train_step(samples, model_for_hyp=trainer.get_model())
            else:

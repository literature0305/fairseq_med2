...
fairseq-train \
    ...
    --optimizer adam --adam-betas '(0.9, 0.98)' --clip-norm 0.0 --beam-search-hyps --segment-level-training-start-iter 30000  \
    --lr 0.0005 --lr-scheduler inverse_sqrt --warmup-updates 4000 --warmup-init-lr 1e-07 \
    --dropout 0.3 --weight-decay 0.0001 --weight-decay 0.0 \
